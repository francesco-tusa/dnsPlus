...
public class SimpleMarketplaceContinuumSimulation extends AbstractMarketplaceContinuumSimulation {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 3. Create Self
            SimpleMarketplaceContinuumSimulation simulation = new SimpleMarketplaceContinuumSimulation();
