...
public enum ExperimentType {
    ...
    EDGE_WORKLOAD_SWEEP("edge_workload_results_") {
        @Override
        public AbstractMarketplaceScenario createScenario(Supplier<AbstractMarketplaceContinuumSimulation> factory) {
    ...
    FEDERATED_LEARNING_3D_SWEEP("fl_dataset_summary_") {
        @Override
        public AbstractMarketplaceScenario createScenario(Supplier<AbstractMarketplaceContinuumSimulation> factory) {
            return new FLDatasetSweepScenario(factory);
        }
    };
     ...
     */
    public abstract AbstractMarketplaceScenario createScenario(Supplier<AbstractMarketplaceContinuumSimulation> factory);
}