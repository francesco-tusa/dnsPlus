...
/**
 * An interface for factories that create Bounded (region-aware) Broker nodes for a topology.
 * This allows a topology generator to be independent of the concrete broker implementation.
 */
public interface BoundedBrokerFactory {
    /**
     * Creates a non-leaf (internal) broker node.
     * @param name The name for the new broker.
     * @return A new broker instance as a generic BoundedBroker.
     */
     ...
     * @return A new leaf broker instance as a BoundedBroker.
     */
