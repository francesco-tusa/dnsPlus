 ...
 */
public class GridTopologyLocationPerformanceSimulation extends AbstractPerformanceSimulation<
...
> {
    ...
    public static void main(String[] args) {
        ...
        GridTopologyLocationPerformanceSimulation simulation = new GridTopologyLocationPerformanceSimulation();
